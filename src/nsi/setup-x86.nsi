...
# General
  ...
  VIAddVersionKey /LANG=0 "InternalName" "SyncClippings-${APPVER}-setup-x86"
...
Section "Install"
  ...
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Sync Clippings Helper" "EstimatedSize" 19978  # KiB
